...
// Receive JSON data from the cart page
...
// Debugging: Check if cart items are received correctly
echo "<pre>";
var_dump($data['cart_items']);
echo "</pre>";
exit(); // Stop execution here to inspect output
...
// ✅ 1. Insert the order with the correct total amount
...
// ✅ 3. Clear cart table (if you're storing items in `cart` table)
